...
TRAIN_TAGS="${TRAIN_TAGS:?set TRAIN_TAGS=v7_ccnews_p256d64_lockbox_step5000_train8192}"
EVAL_TAGS="${EVAL_TAGS:?set EVAL_TAGS=v7_ccnews_p256d64_lockbox_step5000_dev2048}"
MANIFEST_PATH="${MANIFEST_PATH:?set MANIFEST_PATH=$ROOT/results/lockbox_manifests_v7/v7_ccnews_p256d64_lockbox_dev_test.jsonl}"
OUTPUT_TAG="${OUTPUT_TAG:?set OUTPUT_TAG=v7_ccnews_step5000_skip1_hgb_pair}"
...
echo "[deployment-measurement-v7] complete"
