...
def main() -> None:
    ...
    base = subset[subset["model_name"] == args.selected_model].copy().set_index("sequence_idx")
    ...
    out_dir = ROOT / "results" / "calibrated_abstention_v6"
    ...
    plt.tight_layout()
    plt.savefig(plot_dir / f"calibrated_abstention_v6_{args.output_tag}_pareto.png", dpi=160)
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(plot_dir / f"calibrated_abstention_v6_{args.output_tag}_uncertainty_vs_actual.png", dpi=160)
    plt.close()
